...
namespace chess {
	enum class PieceEncoding { WhiteKing, BlackKing, WhiteQueen, BlackQueen, WhiteBishop, BlackBishop, WhiteRook, BlackRook, WhitePawn, BlackPawn, WhiteKnight, BlackKnight };
	...
	public:
		...
		Color getColor();
		char getLabel() const;
		PieceEncoding getPieceEncoding() const;
