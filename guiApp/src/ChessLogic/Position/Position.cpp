...
Position Position::flipPosition(Position pos) {
	return Position(7 - pos.row, pos.column);
}
Position Position::flipHorizontaly(Position pos) {
	return Position(pos.row, 7 -pos.column);
}
}